...
try
{
    ...
    switch (comando)
    {
        ...
        case "help":
            ...
            if (args.Length == 1)
            {
                Console.WriteLine("adopet help <parametro> ous simplemente adopet help  " + "comando que exibe informações de ajuda dos comandos.");
            ...
            break;
        case "show":
            string caminhoASerExibido = args[1];
            using (StreamReader sr = new StreamReader(caminhoASerExibido))
            {
